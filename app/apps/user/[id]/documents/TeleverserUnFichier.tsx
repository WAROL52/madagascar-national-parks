...
import { OpenFolderType } from "./FileSysteme";
...
export default function TeleverserUnFichier({
  ...
  folder: Folder;
  openFolder: OpenFolderType;
  setFolderRoot: React.Dispatch<React.SetStateAction<Folder>>;
}) {
  ...
  return (
    <>
      ...
      >
        ...
        <SaveLoading isLoading={isLoading} textLoading="Téléversement...">
          Importer
        </SaveLoading>
      </button>
      <input
